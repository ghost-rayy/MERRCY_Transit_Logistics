...
import { TRANSIT, SMS, GHANA, GHANA2, GHANA1, GHANA3 } from "./contactInfo";
        ...
        <div className="grid md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-base text-muted-foreground">
              ...
              <li>
                <a href={`tel:${GHANA1.phoneTel}`} className="hover:text-brand-gold transition-colors focus-visible-ring">
                  {GHANA1.phoneDisplay} - <span className=" text-sm">{f.contact1}</span>
                </a>
              </li>
              <li>
                <a href={`tel:${GHANA2.phoneTel}`} className="hover:text-brand-gold transition-colors focus-visible-ring">
                  {GHANA2.phoneDisplay} - <span className=" text-sm">{f.contact2}</span>
                </a>
              </li>
              <li>
                <a href={`tel:${GHANA3.phoneTel}`} className="hover:text-brand-gold transition-colors focus-visible-ring">
                  {GHANA3.phoneDisplay} - <span className=" text-sm">{f.contact3}</span>
                </a>
              </li>

    ...
    <section id="about" className="relative py-24 md:py-32 bg-card overflow-hidden">
      ...
      <div className="relative container-tactical">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="font-mono text-xs uppercase tracking-[0.25em] text-brand-gold">{a.label}</span>
        </div>
        <h2 className="font-heading font-700 text-raw-steel text-4xl md:text-6xl leading-[0.95] mb-8 max-w-4xl">
          {a.titleBefore} <span className="text-brand-gold">{a.titleHighlight}</span> {a.titleAfter}
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 mb-16 md:mb-24">
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <span className="text-brand-gold font-600">MERRCY TRANSIT</span>{a.intro1After}
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed">
            {a.intro2Before}{" "}
        ...
        <div className="mb-16 md:mb-24">
          ...
          <div className="grid md:grid-cols-2 gap-px bg-border">
            ...
            <div className="bg-card p-10 md:p-12 relative group">
              ...
              <h3 className="font-heading font-600 text-2xl text-brand-gold mb-3">{a.protectionTitle}</h3>
              <p className="text-muted-foreground leading-relaxed">{a.protectionDesc}</p>
            </div>
          </div>

          <div className="bg-brand-gold text-brand-navy py-6 px-8 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="grid md:grid-cols-2 gap-px bg-border mb-16 md:mb-24">
          <div className="bg-background p-10 md:p-12">
            <div className="font-mono text-xs uppercase tracking-widest text-brand-gold mb-4">{a.visionLabel}</div>
          ...
          <div className="bg-background p-10 md:p-12">
            <div className="font-mono text-xs uppercase tracking-widest text-brand-gold mb-4">{a.missionLabel}</div>
            <h3 className="font-heading font-600 text-2xl md:text-3xl text-raw-steel mb-4 leading-tight">
              {a.missionTitle}
            </h3>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-border mb-16 md:mb-24">
          {a.values.map((value, i) => (
            <div key={i} className="bg-background p-8 md:p-10 group hover:bg-card transition-colors duration-500">
              <div className="font-heading font-700 text-5xl text-brand-gold/20 group-hover:text-brand-gold/40 transition-colors mb-4">
                {value.num}
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-border mt-16">
          ...
          <div className="relative overflow-hidden bg-brand-navy">
            <img
              src={emsFlyerImage}
              alt="MERRCY SMS Speedster — livraison express en 2H à Conakry"
        ...
        <div className="mt-16 text-center">
          <p className="font-heading font-600 text-2xl md:text-4xl text-raw-steel leading-tight">
            MERRCY TRANSIT: <span className="text-brand-gold">{a.tagline1}</span><br />
            {a.tagline2}
          </p>
          <a
            href="#contact"
            className="inline-flex items-center gap-3 mt-8 font-heading font-600 uppercase text-sm tracking-wider text-brand-gold hover:text-raw-steel transition-colors min-h-[48px] focus-visible-ring group"
          >
            {a.cta}
